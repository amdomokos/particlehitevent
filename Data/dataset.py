...
#                 self.target_max = np.array(norm_params['target_max'])
#         else:
#             self._compute_target_normalization(sample_size=1000)
...
#     def _compute_target_normalization(self, sample_size=1000):
#         print("Computing target normalization parameters with sampling...")
#         import random
...
#         with open(self.norm_file, 'w') as f:
#             json.dump(norm_params, f)
#         print(f"Saved target normalization stats to {self.norm_file}.")
